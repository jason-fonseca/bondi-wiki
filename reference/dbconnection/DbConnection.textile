...
var dbconn = new DbConnection("sqlite::" + MerchantID + "_ProductImages::memory?cache=shared"); //memory URI filename and shared cached - allows sharing between other processes (Server.ExecuteAsyncNoReturn) etc
