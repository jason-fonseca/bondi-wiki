...
- Exit := If the bondi process is running in a process pool - calling Exit will signal that the controlling daemon should shut down the entire pool. NOTE: the currently executing script will halt as if "Response.End();":[Response] was called.
