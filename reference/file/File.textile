...
=:
- OpenTemporaryFile(fileprefix [, mode]) := Open temporary file with optional mode. Can be used to generate an available filename within the system.  returns a file stream object with property: FileName.
