...
=:
- OpenTemporaryFile(fileprefix [, mode]) := Open temporary file with optional mode, will be deleted once closed from file system, returns a file stream object with property: FileName.
